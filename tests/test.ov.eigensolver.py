...
core.init(None, [8, 8, 8, 8], 1, 1.0, backend="numpy", resource_path=".cache")
...
# ov_eig_param.eig_type = enum_quda.QudaEigType.QUDA_EIG_BLK_TR_LANCZOS
# ov_eig_param.block_size = 4
# ov_eig_param.batched_rotate = 1
# ov_eig_param.compute_evals_batch_size = 1
...
ov_eig_param.chirality = enum_quda.QudaChirality.QUDA_LEFT_CHIRALITY
